...
####변경 사항     
1. pom.xml: spring-boot-starter-data-jpa, querydsl-jpa, querydsl-apt 의존성 설정 추가
...
9. repository.querydsl.{ItemRepository2, ItemRepositoryCustom, ItemRepositoryCustomImpl}: QueryDSL을 이용한 repository 인터페이스 정의 및 클래스 구현 (Query type 클래스들은 target/generated-sources/annotations 폴더 밑에 생성됨)
