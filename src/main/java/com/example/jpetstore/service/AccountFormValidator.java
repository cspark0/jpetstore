...
public class AccountFormValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "account.address.addr1", "ADDRESS_REQUIRED", "Address (1) is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "account.address.city", "CITY_REQUIRED", "City is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "account.address.state", "STATE_REQUIRED", "State is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "account.address.zip", "ZIP_REQUIRED", "ZIP is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "account.address.country", "COUNTRY_REQUIRED", "Country is required.");
